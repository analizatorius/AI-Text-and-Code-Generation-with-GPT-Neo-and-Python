...
tokenizer = GPT2Tokenizer.from_pretrained(path, bos_token='<|startoftext|>', eos_token='<|endoftext|>', pad_token='<|pad|>')
...
dataset = MakeDataset(descriptions, tokenizer, max_length=max_length)
